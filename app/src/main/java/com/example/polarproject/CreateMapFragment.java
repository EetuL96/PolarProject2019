...
public class CreateMapFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_create_map, container, false);
        Button buttonSave = (Button) v.findViewById(R.id.buttonSave);
        buttonSave.setOnClickListener(this);
        Button buttonLoad = (Button) v.findViewById(R.id.buttonLoad);
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            case R.id.buttonSave:
                Log.d("LOL","Button Save");
                break;
            case R.id.buttonLoad:
                Log.d("LOL","Button Load");
